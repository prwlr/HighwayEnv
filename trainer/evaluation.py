...
from agents.common.factory import load_environment, load_agent
from agents.common.graphics import AgentGraphics
from agents.common.memory import Transition
from mathutils import near_split, zip_with_singletons
from configuration import serialize
from trainer.graphics import RewardViewer
...
class Evaluation(object):
    ...
    def write_logging(self):
        file_infix = '{}.{}'.format(id(self.wrapped_env), os.getpid())
        trainer.logger.configure()
        trainer.logger.add_file_handler(self.run_directory / self.LOGGING_FILE.format(file_infix))
